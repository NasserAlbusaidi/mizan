...
@nasseralbusaidi/mizan version` returns `0.1.58`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.58
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.58
