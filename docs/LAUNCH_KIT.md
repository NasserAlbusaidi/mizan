...
@nasseralbusaidi/mizan version` returns `0.1.62`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.62
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.62
