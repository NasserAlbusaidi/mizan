...
```bash
npm install -g github:NasserAlbusaidi/mizan#v0.1.54
mizan --demo
mizan --setup
mizan
mizan --feedback
...
@nasseralbusaidi/mizan version` returns `0.1.54`.
Use a versioned release tarball URL for fallback no-install demos and install
copy. Do not use `releases/latest/download/...` for install instructions;
GitHub latest redirects can lag, and npm can reuse cached package URLs.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.54
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.54
