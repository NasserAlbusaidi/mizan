...
```bash
npm install -g github:NasserAlbusaidi/mizan#v0.1.31
mizan --demo
mizan --setup
mizan
mizan --feedback
...
@nasseralbusaidi/mizan version` returns `0.1.31`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.31
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.31
