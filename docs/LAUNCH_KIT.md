...
@nasseralbusaidi/mizan version` returns `0.1.27`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.27
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.27
