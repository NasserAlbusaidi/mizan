...
@nasseralbusaidi/mizan version` returns `0.1.42`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.42
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.42
