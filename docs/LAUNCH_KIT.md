...
@nasseralbusaidi/mizan version` returns `0.1.43`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.43
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.43
