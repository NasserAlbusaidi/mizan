...
@nasseralbusaidi/mizan version` returns `0.1.8`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.8
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.8
