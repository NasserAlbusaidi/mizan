...
@nasseralbusaidi/mizan version` returns `0.1.11`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.11
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.11
