...
@nasseralbusaidi/mizan version` returns `0.1.30`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.30
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.30
