...
@nasseralbusaidi/mizan version` returns `0.1.13`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.13
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.13
