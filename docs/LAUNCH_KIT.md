...
@nasseralbusaidi/mizan version` returns `0.1.14`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.14
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.14
