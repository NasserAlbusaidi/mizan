...
@nasseralbusaidi/mizan version` returns `0.1.35`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.35
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.35
