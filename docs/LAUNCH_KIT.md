...
@nasseralbusaidi/mizan version` returns `0.1.56`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.56
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.56
