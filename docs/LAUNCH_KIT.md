...
@nasseralbusaidi/mizan version` returns `0.1.67`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.67
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.67
