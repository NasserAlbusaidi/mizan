...
@nasseralbusaidi/mizan version` returns `0.1.9`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.9
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.9
