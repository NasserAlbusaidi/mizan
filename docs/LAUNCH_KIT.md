...
@nasseralbusaidi/mizan version` returns `0.1.44`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.44
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.44
