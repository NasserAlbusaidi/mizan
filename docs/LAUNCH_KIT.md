...
@nasseralbusaidi/mizan version` returns `0.1.61`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.61
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.61
