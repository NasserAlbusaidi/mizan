...
@nasseralbusaidi/mizan version` returns `0.1.32`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.32
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.32
