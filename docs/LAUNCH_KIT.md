...
```bash
npm install -g github:NasserAlbusaidi/mizan#v0.1.52
mizan --demo
mizan --setup
mizan
mizan --feedback
...
@nasseralbusaidi/mizan version` returns `0.1.52`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.52
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.52
