...
@nasseralbusaidi/mizan version` returns `0.1.15`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.15
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.15
