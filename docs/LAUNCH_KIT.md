...
@nasseralbusaidi/mizan version` returns `0.1.7`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.7
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.7
