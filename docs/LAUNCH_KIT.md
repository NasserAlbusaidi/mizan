...
@nasseralbusaidi/mizan version` returns `0.1.47`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.47
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.47
