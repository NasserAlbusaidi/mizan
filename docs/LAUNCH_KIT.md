...
@nasseralbusaidi/mizan version` returns `0.1.48`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.48
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.48
