...
@nasseralbusaidi/mizan version` returns `0.1.40`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.40
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.40
