...
@nasseralbusaidi/mizan version` returns `0.1.55`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.55
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.55
