...
@nasseralbusaidi/mizan version` returns `0.1.10`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.10
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.10
