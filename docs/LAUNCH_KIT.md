...
@nasseralbusaidi/mizan version` returns `0.1.12`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.12
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.12
