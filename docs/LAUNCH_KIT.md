...
@nasseralbusaidi/mizan version` returns `0.1.63`.
...
Release: https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.63
...
https://github.com/NasserAlbusaidi/mizan/releases/tag/v0.1.63
